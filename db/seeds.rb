...
lvs1 = Lehrveranstaltung.create([{ titel: "Datenbanken 1", modul_id: "000-111-222", dozent: "Rahm", form: :vorlesung, wochentag: :mo, zeit_von: "11:15", zeit_bis: "12:45", raum: "S3-14", website: "foo.org/db1"}, { titel: "Datenbanken2", dozent: "Rahm", form: :vorlesung, wochentag: :di, zeit_von: "11:15", zeit_bis: "12:45", raum: "S3-12", website: "foo.org/db2"}])

lvs2 = Lehrveranstaltung.create([{ titel: "Grundlagen theoretische Informatik", modul_id: "000-111-222", dozent: "Bogdan", form: :vorlesung, wochentag: [:mi, :fr], zeit_von: ["11:15", "11:15"], zeit_bis: ["12:45", "12:45"], raum: ["S3-14", "S3-12"], website: "foo.org/ti"}])
